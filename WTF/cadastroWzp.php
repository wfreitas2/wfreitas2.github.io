        ...
        <div class="col-xs-12 centro   ">
           <?php 
              ...
              //if($checkprom == true && $nomeprom==true && $emailprom==true )
                    ...
                    echo" <h1> Parabens $nomezap".", </h1>"."<h4>vc receberá nossas promoções no seu $wsapp</h4>"."<a href='homewtf.html'>continuar navegando</a>";
